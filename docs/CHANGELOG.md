...
- [Add CookieJar Support in Golang](https://github.com/deanxv/CycleTLS/issues/260), [duplicate](https://github.com/deanxv/CycleTLS/issues/146), [other duplicate](https://github.com/deanxv/CycleTLS/issues/222)
...
- [remove duplicate sources](https://github.com/deanxv/CycleTLS/issues/85)
- [Added support for extension 17513](https://github.com/deanxv/CycleTLS/issues/70)
- add support for `application/pdf`, 
### Bug Fixes
- [properly add grease](https://github.com/deanxv/CycleTLS/issues/53)
...
### Enhancements
- [Arm and Arm64 compilation support](https://github.com/deanxv/CycleTLS/issues/86)
- [Images are now Base64 encoded for Javascript](https://github.com/deanxv/CycleTLS/issues/76)
### Bug Fixes
- [Fix installation dependencies](https://github.com/deanxv/CycleTLS/issues/84)
...
### Enhancements
- Golang is now handles incoming requests, temporary solution till [this](https://github.com/deanxv/CycleTLS/issues/55) is addressed 
### Bug Fixes
- [Don't kill process if it does not exist](https://github.com/deanxv/CycleTLS/pull/71)
...
### Bug Fixes
- [Fix request Headers not being set](https://github.com/deanxv/CycleTLS/issues/60)
### Enhancements
